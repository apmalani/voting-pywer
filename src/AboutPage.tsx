    ...
    return (
        <div className='AboutPage'>
            ...
            <div style={{marginLeft: '0px'}}>
                <p>
                    Voting Pywer was developed to improve upon <a href="http://powerslave.utu.fi/">Powerslave Mark II</a>, a similar tool developed by the University of Turku.
                    ...
                    <br/>
                    Voting Pywer currently calculates two power indices, however more are soon to be implemented. The two currently implemented are the Banzhaf and Shapley-Shubik power indices,
